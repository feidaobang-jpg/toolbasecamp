...
const toolsConfig = {
    ...
    groups: [
        ...
        },
        {
            ...
            items: [
                { titleKey: 'tools.weightLossPlan.title', url: 'html/life/weight-loss-plan.html', },
                { titleKey: 'tools.studyPlan.title', url: 'html/life/study-plan.html', },
                { titleKey: 'tools.roadTripPlan.title', url: 'html/life/road-trip-plan.html', },
                { titleKey: 'tools.dayTripPlan.title', url: 'html/life/day-trip-plan.html', },
                { titleKey: 'tools.pcUpgradePlan.title', url: 'html/life/pc-upgrade-plan.html', },
                { titleKey: 'tools.savingsPlan.title', url: 'html/life/savings-plan.html', },
                { titleKey: 'tools.interviewPlan.title', url: 'html/life/interview-plan.html', },
                { titleKey: 'tools.seasonalFoodPlan.title', url: 'html/life/seasonal-food-plan.html', },
                { titleKey: 'tools.familyMealPlan.title', url: 'html/life/family-meal-plan.html', },
                { titleKey: 'tools.outfitPlan.title', url: 'html/life/outfit-plan.html', },
                { titleKey: 'tools.travelPackPlan.title', url: 'html/life/travel-pack-plan.html', },
                { titleKey: 'tools.holidayStockPlan.title', url: 'html/life/holiday-stock-plan.html', },
                { titleKey: 'tools.partyHostPlan.title', url: 'html/life/party-host-plan.html', },
                { titleKey: 'tools.kidsWeekendPlan.title', url: 'html/life/kids-weekend-plan.html', },
                { titleKey: 'tools.emergencyKitPlan.title', url: 'html/life/emergency-kit-plan.html', },
                { titleKey: 'tools.officeLunchPlan.title', url: 'html/life/office-lunch-plan.html', },
                { titleKey: 'tools.fitnessWeekPlan.title', url: 'html/life/fitness-week-plan.html', },
                { titleKey: 'tools.lowOilWeekPlan.title', url: 'html/life/low-oil-week-plan.html', },
                { titleKey: 'tools.jobApplyWeekPlan.title', url: 'html/life/job-apply-week-plan.html', },
                { titleKey: 'tools.dateNightPlan.title', url: 'html/life/date-night-plan.html', },
                { titleKey: 'tools.petTravelPlan.title', url: 'html/life/pet-travel-plan.html', }
            ]
        },
        {
    ...
    groups: [
        ...
        },
        {
            ...
            items: [
                ...
                { titleKey: 'tools.whack.title', url: 'html/game/whack.html?v=6' },
                { titleKey: 'tools.shooter.title', url: 'html/game/shooter.html?v=6' },
                { titleKey: 'tools.jumpjump.title', url: 'html/game/jumpjump.html?v=2' },
                { titleKey: 'tools.catcher.title', url: 'html/game/catcher.html?v=6' },
                { titleKey: 'tools.tetris.title', url: 'html/game/tetris.html?v=6' },
                { titleKey: 'tools.memory.title', url: 'html/game/memory.html?v=2' },
                { titleKey: 'tools.runner.title', url: 'html/game/runner.html?v=6' },
                { titleKey: 'tools.mines.title', url: 'html/game/mines.html?v=2' },
                { titleKey: 'tools.slots.title', url: 'html/game/slots.html?v=19' },
                { titleKey: 'tools.sheepstack.title', url: 'html/game/sheepstack.html?v=3' },
                { titleKey: 'tools.diverDave.title', url: 'html/game/diver-dave.html' },
                { titleKey: 'tools.parkour.title', url: 'html/game/parkour.html?v=2' },
                { titleKey: 'tools.cubeRush.title', url: 'html/game/cube-rush.html?v=2' },
