    ...
    groups: [
        {
            ...
            items: [
                ...
                { titleKey: 'tools.bomberman.title', url: 'html/game/bomberman.html?v=3' },
                { titleKey: 'tools.diving.title', url: 'html/game/diving.html?v=2' },
                { titleKey: 'tools.pvz.title', url: 'html/game/pvz.html?v=2' },
