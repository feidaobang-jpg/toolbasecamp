    ...
    groups: [
        {
            ...
            items: [
                { titleKey: 'tools.angryBirds.title', url: 'html/game/angry_birds.html?v=3' },
                ...
                { titleKey: 'tools.gemswap.title', url: 'html/game/gemswap.html?v=8' },
                { titleKey: 'tools.lianliankan.title', url: 'html/game/lianliankan.html' },
                { titleKey: 'tools.brickBreaker.title', url: 'html/game/brick_breaker.html?v=5' },
