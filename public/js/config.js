    ...
    groups: [
        {
            ...
            items: [
                { titleKey: 'tools.angryBirds.title', url: 'html/game/angry_birds.html?v=4' },
                { titleKey: 'tools.bubbleDragon.title', url: 'html/game/bubble_dragon.html?v=5' },
                { titleKey: 'tools.flyBird.title', url: 'html/game/fly_bird.html?v=3' },
                { titleKey: 'tools.frogZuma.title', url: 'html/game/frog_zuma.html?v=5' },
                ...
                { titleKey: 'tools.gemswap.title', url: 'html/game/gemswap.html?v=9' },
                { titleKey: 'tools.lianliankan.title', url: 'html/game/lianliankan.html' },
                { titleKey: 'tools.brickBreaker.title', url: 'html/game/brick_breaker.html?v=6' },
