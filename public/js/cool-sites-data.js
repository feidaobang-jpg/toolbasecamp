/** Geek Frontier cool-sites directory (migrated). */
                ...
                groups: [

                    {
                        ...
                        items: [
                            ...
                            { title: '阿里云', desc: '全球领先的云计算服务平台', url: 'https://www.aliyun.com/', icon: 'https://img.alicdn.com/tfs/TB1_ZXuNcfpK1RjSZFOXXa6nFXa-32-32.ico' },
                            ...
                            { title: 'Tailwind CSS', desc: '只需书写 HTML 代码，无需编写 CSS', url: 'https://www.tailwindcss.cn/', icon: 'https://www.tailwindcss.cn/favicon-32x32.png' },

                            { title: 'Element Plus', desc: '基于 Vue 3，面向设计师和开发者的组件库', url: 'https://element-plus.org/zh-CN/', icon: 'https://element-plus.org/images/element-plus-logo-small.svg' },
...

                    {
                        ...
                        items: [
                            ...
                            { title: 'Vercel', desc: '前端开发者的部署与协作平台', url: 'https://vercel.com/', icon: 'https://assets.vercel.com/image/upload/front/favicon/vercel/favicon.ico' },

                            { title: 'CodePen', desc: '前端代码构建、测试与分享社区', url: 'https://codepen.io/', icon: 'fab fa-codepen', isFontIcon: true },
                ...
                groups: [
...

                    {
                        ...
                        items: [
                            ...
                            { title: 'Google', desc: '全球最大的搜索引擎', url: 'https://www.google.com', icon: 'https://www.google.com/favicon.ico' },
                ...
                groups: [

                    {
                        ...
                        items: [
                            ...
                            { title: '可灵 (Kling)', desc: '快手推出的级视频生成大模型', url: 'https://kling.kuaishou.com/', icon: 'fas fa-video', isFontIcon: true },
                            ...
                            { title: 'RunningHub', desc: '高可用性云端 ComfyUI，在线创作 AI 应用', url: 'https://www.runninghub.cn/', icon: 'fas fa-cloud', isFontIcon: true },

                            { title: '文心一言', desc: '百度全新一代知识增强大语言模型', url: 'https://yiyan.baidu.com/', icon: 'https://yiyan.baidu.com/favicon.ico' },
...

                    {
                        ...
                        items: [
                            ...
                            { title: 'ComfyUI', desc: '最强大的节点式 AI 绘图后端', url: 'https://github.com/comfyanonymous/ComfyUI', icon: 'https://github.com/fluidicon.png' },

                            { title: 'Civitai', desc: '开源生成式 AI 模型社区 (C站)', url: 'https://civitai.com/', icon: 'https://civitai.com/favicon.ico' },
                            ...
                            { title: 'ChatGPT', desc: 'OpenAI 开发的划时代聊天机器人', url: 'https://chat.openai.com/', icon: 'https://openai.com/favicon.ico' },

                            { title: 'Claude', desc: 'Anthropic 开发的 AI 助手，擅长写作', url: 'https://claude.ai/', icon: 'fas fa-robot', isFontIcon: true },

                            { title: 'Gemini', desc: 'Google 最强大、最通用的 AI 模型', url: 'https://gemini.google.com/', icon: 'https://www.gstatic.com/lamda/images/gemini_favicon_f069958c85030da8.png' },
                ...
                groups: [

                    {
                        ...
                        items: [
                            ...
                            { title: 'HelloGitHub', desc: '分享 GitHub 上有趣、入门级的开源项目', url: 'https://hellogithub.com/', icon: 'https://hellogithub.com/favicon.ico' },

                            { title: '吾爱破解', desc: '国内最大的软件安全与逆向分析社区', url: 'https://www.52pojie.cn/', icon: 'https://www.52pojie.cn/favicon.ico' },

                            { title: 'CSDN', desc: '专业开发者社区', url: 'https://www.csdn.net/', icon: 'https://g.csdnimg.cn/static/logo/favicon32.ico' },

                            { title: 'LeetCode', desc: '全球极客挚爱的技术成长平台', url: 'https://leetcode.cn/', icon: 'https://leetcode.cn/favicon.ico' },

                            { title: 'InfoQ', desc: '促进软件开发领域知识与创新', url: 'https://www.infoq.cn/', icon: 'https://static001.infoq.cn/static/infoq/img/logo-32.png' }
...

                    {
                        ...
                        items: [
                            ...
                            { title: 'Reddit', desc: '互联网的头条', url: 'https://www.reddit.com/', icon: 'https://www.reddit.com/favicon.ico' },
                ...
                groups: [
...

                    {
                        ...
                        items: [
                            ...
                            { title: 'Unsplash', desc: '免费高质量图片素材', url: 'https://unsplash.com/', icon: 'https://unsplash.com/favicon.ico' },

                            { title: 'Pinterest', desc: '全球最大的创意灵感图片站', url: 'https://www.pinterest.com/', icon: 'fab fa-pinterest', isFontIcon: true },

                            { title: 'itch.io', desc: '独立游戏托管与发现平台', url: 'https://itch.io/', icon: 'fab fa-itch-io', isFontIcon: true },

                            { title: 'Dribbble', desc: '设计师灵感分享平台', url: 'https://dribbble.com/', icon: 'https://cdn.dribbble.com/assets/favicon-b38525134603b9513174f40206a595d08983ee337eb11a648f58b2095f32eb91.ico' },

                            { title: 'Dribbble', desc: '设计师灵感社区', url: 'https://dribbble.com/', icon: 'fab fa-dribbble', isFontIcon: true },

                            { title: 'Behance', desc: 'Adobe 旗下的设计师展示平台', url: 'https://www.behance.net/', icon: 'fab fa-behance', isFontIcon: true },

                            { title: 'Pinterest', desc: '全球最大的图片社交分享网站', url: 'https://www.pinterest.com/', icon: 'fab fa-pinterest', isFontIcon: true },

                            { title: 'Unsplash', desc: '高质量免费无版权图片库', url: 'https://unsplash.com/', icon: 'fab fa-unsplash', isFontIcon: true },

                            { title: 'Figma', desc: '在线协作界面设计工具', url: 'https://www.figma.com/', icon: 'https://static.figma.com/app/icon/1/favicon.ico' },

                            { title: 'Font Awesome', desc: '互联网最流行的图标集和工具包', url: 'https://fontawesome.com/', icon: 'fab fa-font-awesome', isFontIcon: true },

                            { title: 'Google Fonts', desc: '免费开源的字体库', url: 'https://fonts.google.com/', icon: 'fab fa-google', isFontIcon: true }
                ...
                groups: [

                    {
                        ...
                        items: [
                            ...
                            { title: '飞书', desc: '先进企业协作与管理平台', url: 'https://www.feishu.cn/', icon: 'https://lf3-static.bytednsdoc.com/obj/eden-cn/hbeh7_km/favicon.ico' },
