...
window.TB_LOCALES.en = {
    ...
    tools: {
        ...
        smartErase: {
            title: 'Smart Erase',
            desc: 'Erase watermarks, mosaics and marks with server repair, or paint mosaic locally.',
            dropTitle: 'Click or drop an image',
            dropHint: 'JPG, PNG, or WebP',
            tip: 'Tip:',
            tipErase: 'Draw boxes over watermarks, mosaics or marks, then erase. Server OpenCV repair (upload). You can keep editing after.',
            tipMosaic: 'Paint with the brush to add mosaic. Runs locally, no upload.',
            modeErase: 'Smart erase',
            modeMosaic: 'Add mosaic',
            brushLabel: 'Brush size',
            blockLabel: 'Mosaic block',
            process: 'Erase selection',
            addBox: 'Add box',
            delBox: 'Delete box',
            undoMosaic: 'Undo stroke',
            download: 'Download',
            clear: 'Clear',
            invalidFile: 'Please choose an image file',
            loadFailed: 'Failed to load image',
            processFail: 'Erase failed',
            networkError: 'Cannot reach the server. Please try again later.',
            notReady: 'Erase service is not ready yet. Please retry in a minute.'
        },
        iconMaker: {
            title: 'Icon Maker',
