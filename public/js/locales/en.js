...
window.TB_LOCALES.en = {
    ...
    hub: {
        ...
        howtoBody: 'Option A: pay via WeChat QR on the About page, then contact the admin to credit your balance. Option B: buy a redeem code from Xianyu seller feidaobang → redeem in Profile (top right). Then use Image-to-Image or Text-to-Image (charged only on success).',
        howtoRedeem: 'Redeem',
        howtoAboutPay: 'WeChat QR',
    ...
    about: {
        ...
        aiTitle: 'AI Images',
        aiDesc: 'Image-to-Image (instruct edit) and Text-to-Image. Top up via WeChat Pay or a Xianyu redeem code; charged only on success.',
        ...
        topUpTitle: 'Top up',
        wechatPayTip: 'Scan the WeChat Pay QR below to pay, then contact the admin with your login account so balance can be credited. Or buy a redeem code from Xianyu seller feidaobang and redeem in Profile.',
        wechatPayAlt: 'WeChat Pay QR code',
        wechatPayCaption: 'WeChat Pay — scan to pay, then message admin',
