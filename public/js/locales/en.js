...
window.TB_LOCALES.en = {
    ...
    privateHub: {
        ...
        homePc: {
            ...
            gameSpriteHint: 'Brief → pick camera (side-scroll / top-down) → stills → actions → Godot ZIP.',
            ...
            gameSpriteCameraHint: 'Side-scroll for platformers; top-down for survivor-likes. Each makes 1 still and auto-uses it for actions.',
            gameSpriteCameraFront: 'Front view',
            gameSpriteCameraTurnaround: '3-view refs',
