...
window.TB_LOCALES.en = {
    ...
    privateHub: {
        ...
        homePc: {
            ...
            trailerHint: 'Title/synopsis → DeepSeek shots → stills (multi-pick optional) → I2V + VO. Default 1 candidate auto-continues; clip 3–10s; segments default 1.',
            ...
            trailerHistoryHint: 'Reuse stills from earlier runs to compose without regenerating images.',
