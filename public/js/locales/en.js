...
window.TB_LOCALES.en = {
    ...
    privateHub: {
        ...
        ops: {
            ...
            stickersTitle: 'Classic images',
            stickersDesc: 'Batch-upload classic images (stickers, curated art, etc.) to the Images hub “Classic” tab. WeChat users can long-press to save or forward.',
            stickersLoading: 'Loading…',
            stickersUploadTitle: 'Batch upload',
            stickersUploadDesc: 'PNG / JPG / GIF / WebP (multi-select). Names like pack-name.png are parsed; or set a default category below.',
            stickersPick: 'Choose images',
            stickersCategory: 'Default category',
            stickersCategoryLabel: 'Category',
            stickersRefresh: 'Refresh',
            stickersPublic: 'Public images page',
            stickersListTitle: 'Classic images',
    ...
    hub: {
        ...
        imagesPage: {
            ...
            stickersSub: 'Admin-uploaded classic images (stickers, curated art, etc.) — download or long-press to forward in WeChat.',
