...
window.TB_LOCALES.en = {
    ...
    tools: {
        ...
        instructEdit: {
            ...
            costHintEmpty: 'Select at least one model. Cost ≈ sum of unit prices × image count.',
            costHint: 'This run ≈ ¥{price} ({images} images × {models} models = {runs} calls, uses {runs} quota)',
            tip: 'Tip:',
            tipBody: 'Wan 2.6 is recommended by default. Multi-select to compare; batch runs are queued with rate-limit retries. Download promptly.',
            download: 'Download',
            clear: 'Clear',
        ...
        textToImage: {
            ...
            modelLabel: 'Model',
            modelZTurbo: 'Z-Image Turbo · ≈¥0.04 (recommended)',
            modelWan27: 'Wan 2.7 · ≈¥0.3',
            modelWan27pro: 'Wan 2.7-Pro · ≈¥0.6',
            model20: 'Qwen 2.0 · ≈¥0.2',
            selectAllModels: 'Select all',
            deselectAllModels: 'Deselect all',
            costHintEmpty: 'Select at least one model.',
            costHint: 'This run ≈ ¥{price} ({models} models = {runs} calls, uses {runs} quota)',
            tip: 'Tip:',
            tipBody: 'Describe subject, style and lighting. Default to Z-Image Turbo; multi-select to compare. Queued with retries.',
            download: 'Download',
            clear: 'Clear',
