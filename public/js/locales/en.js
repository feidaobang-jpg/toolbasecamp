...
window.TB_LOCALES.en = {
    ...
    privateHub: {
        ...
        homePc: {
            ...
            seriesHint: 'Drop synopsis → auto episode/scene/shot + director prompts → confirm character/scene stills (@image bind) → one-click shoot scene → merge episode export.',
            ...
            seriesVideoModeHint: 'Default: Wan 2.2 14B GGUF Q5_K_M with IndexTTS VO; LTX native audio also available.',
