...
window.TB_LOCALES.en = {
    ...
    tools: {
        ...
        refToVideo: {
            ...
            desc: 'Upload reference stills and rewrite the story (e.g. Huaqiang meme remakes). Choose HappyHorse (cheaper) or Seedance 2.5 via XiaoYao (up to 30s).',
            modelLabel: 'Model',
            ...
            promptLabel: 'Prompt',
            promptPlaceholder: 'Use [Image 1], [Image 2] for uploaded refs. Example: [Image 1] as Huaqiang argues with [Image 2] the vendor…',
            presetHuaqiang: 'Huaqiang melon',
            presetStreet: 'Street bargain',
            presetDuo: 'Two-character skit',
            presetTexts: {
                huaqiang: '[Image 1] plays Huaqiang, [Image 2] plays the melon vendor. Summer roadside melon stall. Huaqiang taps and tastes a melon, asks if it is ripe; the vendor answers eagerly; then a classic comic argument about sandy flesh vs unripe melon. Exaggerated expressions, clear dialogue, cuts between the two and the stall, smooth comedy timing.',
            ...
            estimateLine: 'This run ≈ ¥{price} ({duration}s · {resolution})',
            tip: 'Tip:',
            tipBody: 'Huaqiang remakes: Image 1 = buyer, Image 2 = vendor. Tap the preset, then generate. Seedance is pricier but longer and stronger.',
            run: 'Generate',
            downloadMp4: 'Download MP4',
            clear: 'Clear',
        ...
        videoEdit: {
            ...
            promptPlaceholder: 'e.g. Replace the buyer with the person in the reference image; keep the stall and dialogue timing',
        ...
        aiMusic: {
            title: 'AI Music',
            desc: 'Generate songs with MiniMax or Suno. Sign-in required; Music-3.0-free is ¥0; paid models charged on success.',
            modelLabel: 'Model',
            modelFree: 'Music-3.0-free · ¥0',
            ...
            costNote: 'Model {model}: ¥{price} per successful song (¥0 for the free model).',
