...
window.TB_LOCALES.en = {
    ...
    privateHub: {
        ...
        homePc: {
            ...
            gameSpriteCandidatesLabel: 'Still candidates',
            gameSpriteActionsLabel: 'Actions (character/monster)',
            gameSpriteActionsHint: 'Labels follow UI language; Godot export keeps English anim names (idle / walk…). Props/buildings/scenes skip actions.',
            ...
            gameSpriteStillsHint: 'Select one still as IP, then confirm to run actions; or upload your own reference.',
