...
window.TB_LOCALES.en = {
    ...
    privateHub: {
        ...
        homePc: {
            ...
            trailerTitle: '1-min trailer',
            trailerDesc: 'Title/synopsis → pick shot stills → ~60s rough cut',
            trailerHint: 'Enter a book/film title or synopsis → DeepSeek shot list → pick keyframes → Wan 2.2 image-to-video + VO rough cut. Finish in CapCut.',
            ...
            trailerVideoModeLabel: 'Compose mode',
            trailerVideoModeI2v: 'Image-to-video (Wan 2.2 5B)',
