...
window.TB_LOCALES.en = {
    ...
    tools: {
        ...
        todoList: {
            title: 'To-Do List',
            desc: 'Add, check off, and clear tasks. Requires sign-in; saved to your account.',
            ...
            stats: '{pending} pending · {doing} in progress · {done} done',
            emptyText: 'Please enter a task',
            invalidStatus: 'Invalid status',
            statusPending: 'Pending',
            statusDoing: 'In progress',
            statusDone: 'Done',
            cycleStatus: 'Click to cycle: pending → in progress → done',
            editHint: 'Double-click to edit'
        },
        taskList: {
            title: 'Task List',
            desc: 'Typed checklists with open / done only. Requires sign-in.',
            placeholder: 'Add an item…',
            add: 'Add',
            type: 'Type',
            filterAllCats: 'All types',
            filterStatusAll: 'All',
            filterPending: 'Open',
            filterDone: 'Done',
            empty: 'No items yet. Pick a type and add one.',
            clearDone: 'Clear completed',
            clearDoneConfirm: 'Clear completed items in the current filter?',
            deleteConfirm: 'Delete “{text}”?',
            stats: '{pending} open · {done} done',
            emptyText: 'Please enter an item',
            invalidCategory: 'Invalid type',
            statusPending: 'Open',
            statusDone: 'Done',
