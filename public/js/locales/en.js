...
window.TB_LOCALES.en = {
    ...
    hub: {
        ...
        imagesPage: {
            ...
            stickersTip: 'GIFs autoplay in view. On Baidu: open image → “Open original” → long-press (often a still on white; use Download for animation).',
            stickersLongPress: 'Tap “Open original”, wait for the white-backed image, then long-press (use Download for animation).',
            stickersBaiduShareTip: 'Baidu App: tap “Open original”, wait for the white-backed image, then long-press. Share is often a still image; use Download for the animated GIF.',
