...
window.TB_LOCALES.en = {
    ...
    hub: {
        ...
        imagesPage: {
            title: 'Images',
            sub: 'AI images users chose to publish (text-to-image / image edit). Off by default.',
    ...
    tools: {
        ...
        gifSticker: {
            ...
            desc: 'Crop to square, add caption, compress for WeChat — all local, nothing uploaded.',
            dropTitle: 'Click or drop an image / GIF',
            dropHint: 'JPG, PNG, WebP, GIF',
            sizeLabel: 'Output size',
            size240: '240 × 240 (WeChat sticker)',
            size512: '512 × 512',
            focusX: 'Crop focus (horizontal)',
            focusY: 'Crop focus (vertical)',
            captionLabel: 'Caption (optional)',
            captionPh: 'Meme text, e.g. Shocked, Speechless',
            ...
            encoding: 'Encoding…',
            tip: 'Tip:',
            tipBody: 'In WeChat, long-press the preview to save or forward; or use Download and follow the tip.',
            wechatBanner: 'In WeChat: long-press the result to save or forward; for GIF files, open in browser to download.',
            meta: 'Source {width} × {height} → output {out} × {out}',
            invalidFile: 'Please choose an image or GIF file',
            loadFailed: 'Failed to load file',
            exportFailed: 'Export failed',
            gifUnavailable: 'GIF encoder unavailable — try PNG/JPEG'
        },
        imageResize: {
            title: 'Resize',
        ...
        aiMeme: {
            title: 'AI Meme / Sticker',
            desc: 'Generate 1:1 meme stickers from text or a photo. Sign-in required; billed on success.',
            modeLabel: 'Mode',
            modeText: 'Text only',
            modePhoto: 'From photo',
            modeTextHint: 'Describe a meme or sticker; output is 1:1 square.',
            modePhotoHint: 'Upload a photo and describe how to turn it into a meme/sticker.',
            dropTitle: 'Click or drop a photo',
            dropHint: 'JPG / PNG / WebP — optional for text-only mode',
            removePhoto: 'Remove photo',
            prompt: 'Prompt',
            promptPh: 'e.g. Shocked cat with big eyes, funny meme style…',
            styleLabel: 'Meme preset',
            styleHint: 'Tap a preset to append style hints (editable).',
            styleSticker: 'Sticker',
            styleMeme: 'Meme',
            styleQ版: 'Chibi',
            styleEmoji: 'Emoji pack',
            styleReaction: 'Reaction',
            modelLabel: 'Model',
            modelZTurbo: 'Z-Image Turbo · ¥0.08 (recommended)',
            modelLive: 'MiniMax Image-01-Live (anime) · ¥0.05',
            model01: 'MiniMax Image-01 · ¥0.05',
            modelWan27: 'Wan 2.7 · ¥0.4',
            costHintEmpty: 'Select at least one model.',
            costHint: 'This run ¥{price} ({models} models = {runs} calls; billed on success)',
            tip: 'Tip:',
            tipBody: 'Generates a single sticker (one subject, thick white outline), not a collage or grid. Z-Image Turbo recommended. In WeChat, long-press the result to save or forward.',
            download: 'Download',
            clear: 'Clear',
            needPrompt: 'Please enter a prompt',
            needPhoto: 'Please upload a photo',
            needModel: 'Select at least one model',
            failed: 'Generation failed',
            partialFail: 'Some failed:',
            progressModel: 'Generating {current}/{total}: {model}',
