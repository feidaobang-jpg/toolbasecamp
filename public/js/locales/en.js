...
window.TB_LOCALES.en = {
    ...
    tools: {
        ...
        speechTts: {
            ...
            desc: 'MiniMax speech-2.8 text-to-speech with voice cloning. Sign-in required; charged from wallet on success.',
            modelLabel: 'Model',
            voiceLabel: 'Voice',
            voiceSelectedPrefix: 'Selected:',
            voiceFilterPh: 'Search voices…',
            voiceFilterEmpty: 'No matching voices',
            voiceHint: 'Single select — pick one voice for synthesis (not multi-select, not a prompt). Dashed chips are cloned voices.',
            textLabel: 'Text',
            textPh: 'Enter text to synthesize…',
            speedLabel: 'Speed',
            tip: 'Tip:',
            tipBody: 'Charged by characters × model rate after success. First synthesis with a cloned voice also charges the clone fee (¥9.9 list × markup). Cloned voices marked * have not paid the clone fee yet.',
            run: 'Generate',
            download: 'Download',
            clear: 'Clear',
            generating: 'Synthesizing…',
            cloning: 'Cloning voice…',
            costNote: '{model}: about ¥{rate} / 10k chars; estimate ¥{estimate} (clone fee ~¥{cloneFee} when pending).',
            needText: 'Please enter text',
            needVoice: 'Please select a voice',
            tooLong: 'Text is too long (max {max} characters)',
            needCloneFile: 'Upload an audio sample (mp3 / m4a / wav, 10s–5min)',
            cloneTitle: 'Voice cloning',
            cloneHint: 'Upload mp3 / m4a / wav, 10s–5min, max 15MB. Preview charges TTS only; clone fee is charged on first synthesis.',
            cloneLabel: 'Name',
            cloneLabelPh: 'My voice',
            cloneRun: 'Clone & preview',
            cloneOk: 'Clone preview done · preview ¥{price} · first synthesis will add clone fee ~¥{fee}',
            cloneOkNotify: 'Voice created. First synthesis with it will charge clone fee ~¥{fee}.',
