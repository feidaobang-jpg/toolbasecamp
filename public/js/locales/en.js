...
window.TB_LOCALES.en = {
    ...
    tools: {
        ...
        imageEnhance: {
            title: 'Image Enhance',
            desc: 'Improve document photos: straighten, remove shadows, sharpen text, and more. Requires sign-in and daily quota.',
            dropTitle: 'Click or drop an image',
            dropHint: 'JPG, PNG, WebP — max 8MB',
            taskLabel: 'Enhance mode',
            tip: 'Tip:',
            tipBody: 'Each run uses one enhance quota. Download when ready.',
            run: 'Enhance',
            download: 'Download',
            clear: 'Clear',
            tasks: {
