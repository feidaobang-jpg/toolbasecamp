...
window.TB_LOCALES.en = {
    ...
    tools: {
        ...
        instructEdit: {
            ...
            refModeMultiHint: 'Multi: image 1 is primary, others are references. Describe e.g. “face from #1, outfit from #2”. Not batch — need at least 2 images.',
            dropTitle: 'Click or drop images (multi-select)',
            dropHint: 'JPG / PNG / WebP — max 8MB each, up to 4 (batch)',
            dropHintMulti: 'JPG / PNG / WebP — max 8MB each, 2–4 images as references',
            sourceMain: 'Main',
            sourceRef: 'Ref {n}',
