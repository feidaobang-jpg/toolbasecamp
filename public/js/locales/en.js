...
window.TB_LOCALES.en = {
    ...
    privateHub: {
        ...
        ops: {
            ...
            stickersUploadDesc: 'PNG / JPG / GIF / WebP (multi-select). Pick a category first, then upload.',
            ...
            stickersUploadDone: 'Done: {ok} ok, {skip} skipped (already uploaded), {fail} failed, {total} total',
