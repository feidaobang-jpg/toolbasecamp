...
window.TB_LOCALES.en = {
    ...
    privateHub: {
        ...
        homePc: {
            ...
            img2imgQualityHigh: 'High quality (~1.5MP·8 steps)',
            img2imgQualityHint: '16GB VRAM can use high quality; if ComfyUI OOM, switch to standard.',
            ...
            img2imgDropHint: 'JPG, PNG, or WebP — up to 8, processed one by one',
    ...
    tools: {
        ...
        instructEdit: {
            ...
            dropHint: 'JPG / PNG / WebP — max 8MB each, up to {max} (batch)',
            dropHintMulti: 'JPG / PNG / WebP — max 8MB each, 2–{max} images as references',
            sourceMain: 'Main',
            sourceRef: 'Ref {n}',
