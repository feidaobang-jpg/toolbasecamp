...
window.TB_LOCALES.en = {
    ...
    privateHub: {
        ...
        homePc: {
            ...
            trailerVideoModeHint: 'Multi-select OK: same stills run each engine in order for side-by-side compare. Default Wan (IndexTTS VO); LTX keeps native audio. On engine failure, Ken Burns is still used as automatic fallback.',
