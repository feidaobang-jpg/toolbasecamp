...
window.TB_LOCALES.en = {
    ...
    privateHub: {
        ...
        homePc: {
            ...
            trailerHint: 'Enter a book/film title or synopsis → DeepSeek builds a ~60s shot list → pick keyframe candidates → TTS rough cut. Finish in CapCut; real Wan/LTX I2V comes later.',
            ...
            trailerShotsHint: 'Select one still per shot, then confirm to compose.',
