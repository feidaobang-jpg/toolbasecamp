...
window.TB_LOCALES.en = {
    ...
    tools: {
        ...
        imageToAnimation: {
            ...
            desc: 'Upload an image, describe the motion, and generate a short Wan clip. Sign-in required; billed from balance on success.',
            dropTitle: 'Click or drop an image',
            ...
            res1080: '1080P · ~¥2/s',
            costNote: 'Billed at official list ×2: ~¥1.2/s at 720P, ~¥2/s at 1080P. Charged only on success.',
            estimateLine: 'This run ≈ ¥{price} ({duration}s · {resolution})',
            tip: 'Tip:',
            tipBody: 'Silent Wan clip, usually 1–5 min. Prefer 5s + 720P + presets when testing prompts.',
            run: 'Generate',
