...
window.TB_LOCALES.en = {
    ...
    privateHub: {
        ...
        homePc: {
            ...
            img2imgHint: 'Default: Qwen instruct edit (identity, background, style presets). Z-Image is full-image resampling—not for instruct edits.',
            ...
            img2imgDropTitle: 'Click or drop a reference image',
            img2imgDropHint: 'JPG, PNG, or WebP',
            ...
            img2imgPresetHint: 'Style presets apply to Qwen instruct edit only (same prompts as the public tool). Local Rapid may be weaker than cloud on some presets.',
            download: 'Download',
