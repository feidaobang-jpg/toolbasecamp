...
window.TB_LOCALES.en = {
    ...
    tools: {
        ...
        watermarkRemoval: {
            ...
            tip: 'Tip:',
            tipBody: 'Draw boxes, then clear. Works best on stamp-like watermarks; complex translucent logos are limited.',
            undo: 'Undo box',
            process: 'Clear regions',
            download: 'Download',
            clear: 'Clear',
            invalidFile: 'Please choose an image file',
            loadFailed: 'Failed to load image'
        ...
        idCardCopy: {
            ...
            tip: 'Tip:',
            tipBody: 'Device files only. Download the PNG for printing.',
            render: 'Generate sheet',
            download: 'Download PNG',
            clear: 'Clear',
