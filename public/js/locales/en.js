...
window.TB_LOCALES.en = {
    ...
    tools: {
        ...
        instructEdit: {
            ...
            compareBoth: 'Compare both (2 images, uses 2 quota · ≈¥0.7)',
            tip: 'Tip:',
            tipBody: 'Be specific. One model uses 1 quota; compare uses 2. Prices are approximate. Download promptly.',
            download: 'Download',
            clear: 'Clear',
            needPrompt: 'Please enter an edit instruction',
            tooLarge: 'Image must be 8MB or smaller',
            failed: 'Edit failed',
            partialFail: 'Some models failed:',
