...
window.TB_LOCALES.en = {
    ...
    privateHub: {
        ...
        homePc: {
            ...
            gameSpriteHint: 'Brief → pick camera (side/front/top-down/turnaround) → stills → actions → Godot ZIP.',
            ...
            gameSpriteCameraHint: 'Side/front/top each make 1 still and auto-use; turnaround makes front+back+side (actions use side).',
            ...
            gameSpriteStillsHint: 'Single-view modes auto-use the 1 still. For turnaround, confirm the side hero for actions. Zoom for large view.',
            gameSpriteStillsLive: 'Generating: preview ready images now; confirm pick after all are done.',
            gameSpriteNeedSidePick: 'Pick the side hero for actions (do not run I2V from front/back)',
            gameSpriteNeedHeroPick: 'Pick the hero still that matches the game camera (turnaround → side hero)',
