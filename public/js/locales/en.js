...
window.TB_LOCALES.en = {
    ...
    tools: {
        ...
        addWatermark: {
            title: 'Add Watermark',
            desc: 'Add a text watermark locally. Drag to place or use presets. Nothing is uploaded.',
            dropTitle: 'Click or drop an image',
            dropHint: 'JPG, PNG, or WebP',
            tip: 'Tip:',
            tipBody: 'Enter text, adjust style, then generate. Drag the watermark on the canvas or pick a corner preset.',
        ...
        removeBackground: {
            ...
            desc: 'One-click portrait background removal. Transparent PNG. Requires sign-in and daily quota.',
            dropTitle: 'Click or drop a portrait photo',
            dropHint: 'JPG / PNG - max 5MB recommended',
            shareQuota: 'Shares the same daily quota as ID Photo / Smart Cutout.',
        ...
        smartCutout: {
            ...
            shareQuota: 'Shares the same daily quota as ID Photo / Remove Background.',
            run: 'Cut out',
            download: 'Download',
            clear: 'Clear',
