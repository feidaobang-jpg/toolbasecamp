...
window.TB_LOCALES.en = {
    ...
    privateHub: {
        ...
        homePc: {
            ...
            img2imgHint: 'Default: Qwen Image Edit (manga→real, change background, etc.). Optional Z-Image Turbo redraw (Denoise adjustable; may change composition more).',
            img2imgEngineLabel: 'Engine',
            img2imgEngineQwen: 'Qwen instruct edit (recommended)',
            img2imgEngineZImage: 'Z-Image Turbo redraw',
