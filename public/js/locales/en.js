...
window.TB_LOCALES.en = {
    ...
    privateHub: {
        ...
        ops: {
            ...
            stickersUploadDesc: 'PNG / JPG / GIF / WebP (multi-select). Single-frame GIFs go to Still; multi-frame to GIF. Generic names like (47) are auto-replaced with OCR text from the image. Duplicates are detected by file content, not numbered filenames. Pick a category first, then upload.',
            ...
            stickersUploadDone: 'Done: {ok} ok, {dup} duplicate skipped, {fail} failed, {total} selected',
            ...
            stickersCatWallpaper: 'Wallpapers',
            stickersCatComic: 'Comics',
            stickersCatScenery: 'Scenery',
            stickersCatPeople: 'People',
            stickersCatPet: 'Pets',
    ...
    hub: {
        ...
        imagesPage: {
            ...
            stickersSub: 'Admin-uploaded images (stickers, wallpapers, etc.) — browse by category, or long-press to forward in WeChat.',
            tip: 'GIFs autoplay when scrolled into view. Thumbnails can be long-pressed to forward quickly; tap to open the original for HD save/forward. Download tips open in browser.',
            stickersTip: 'GIFs autoplay in view. On Baidu App: tap the image → “Open original” → wait until it fully loads, then long-press to share (long-pressing the thumbnail often goes black).',
            stickersLongPress: 'Tap “Open original” below, wait for the white-backed image, then long-press to share.',
            stickersBaiduShareTip: 'Baidu App: tap “Open original” below, wait until the white-backed image fully loads, then long-press to share to WeChat. Long-pressing the thumb/preview often yields a black frame.',
            stickersTapOpen: 'Long-press a thumbnail to quickly forward (lower quality); tap to open the original, then long-press to save/forward in HD',
    ...
    tools: {
        ...
        refToVideo: {
            ...
            desc: 'Upload 1–9 character/scene stills and rewrite the story (e.g. Huaqiang melon meme remakes). Keep faces consistent. Max 15s per clip — not a native 2-minute video.',
            modelLine: 'Model: happyhorse-1.1-r2v · up to 9 reference images',
            dropTitle: 'Click or drop reference images',
            dropHint: '1–9 images · JPG/PNG/WebP · short side ≥400px · ≤8MB each. Order maps to [Image 1], [Image 2]…',
            promptLabel: 'Prompt',
            ...
            durationLabel: 'Duration',
            durationHint: '3–15 seconds only (API limit). For ~2 minutes, generate multiple clips and stitch later.',
            resolutionLabel: 'Resolution',
            ratioLabel: 'Aspect ratio',
            res480: '480P · cheaper (~¥0.9/s)',
            res720: '720P · recommended (~¥1.8/s)',
            res1080: '1080P · sharper (~¥2.4/s)',
            costNote: 'HappyHorse R2V: same tiers as T2V (~¥0.9/s 480P, ~¥1.8/s 720P, ~¥2.4/s 1080P). Max 15s. Charged only on success.',
            estimateLine: 'This run ≈ ¥{price} ({duration}s · {resolution})',
            tip: 'Tip:',
            tipBody: 'Huaqiang remakes: Image 1 = buyer, Image 2 = vendor. Tap the preset, generate 10–15s. Longer videos need multiple runs + an editor.',
            run: 'Generate',
            downloadMp4: 'Download MP4',
            clear: 'Clear',
            notConfigured: 'DashScope is not configured on the server (DASHSCOPE_API_KEY).',
            ...
            tooLarge: 'Each reference image must be ≤ 8MB',
            ...
            downloading: 'Fetching video…',
            generating: 'Generating…',
            failed: 'Generation failed. Try other images or prompt.'
        },
        videoEdit: {
            title: 'Video Edit',
        ...
        textToImage: {
            ...
            modelGptImage2: 'GPT Image 2 · ¥0.24',
            modelNanoBananaPro: 'Nano Banana Pro · ¥0.24',
            ...
            tip: 'Tip:',
            tipBody: 'Charged only on success. Results saved in local history. Full color by default (unless you ask for B&W/line art). MiniMax Image-01 recommended. GPT Image 2 / Nano Banana Pro use XiaoYao relay. Multiple models run one by one.',
            publicLabel: 'Publish to the Images page',
            publicHint: 'Off by default. When on, everyone can browse and download it on Images.',
            download: 'Download',
            clear: 'Clear',
        ...
        aiMusic: {
            title: 'AI Music',
            desc: 'Generate songs with MiniMax Music. Sign-in required; Music-3.0-free is ¥0, Music-3.0 is ¥2 per successful song.',
            modelLabel: 'Model',
            ...
            titleHint: 'If empty, DeepSeek names the track from lyrics or style (MiniMax music API does not return a title).',
            styleFolk: 'Folk',
            stylePop: 'Pop',
            styleLofi: 'Lo-fi',
            styleEdm: 'EDM',
            ...
            tip: 'Tip:',
            tipBody: 'Generation often takes 1–3 minutes (auto-lyrics writes lyrics first). Stay on this page. Charged only on success. The free model has a lower RPM.',
            clear: 'Clear',
            download: 'Download',
