...
window.TB_LOCALES.en = {
    ...
    hub: {
        ...
        imagesPage: {
            ...
            tip: 'List shows thumbnails: long-press to quickly forward (lower quality); tap to open the original, then long-press to save/forward in HD. Download tips open in browser.',
            stickersTip: 'List shows thumbnails: long-press to quickly forward (lower quality); tap to open the original, then long-press to save/forward in HD.',
