...
window.TB_LOCALES.en = {
    ...
    about: {
        ...
        metaDescription: 'About Tool Basecamp and A Hui — tools, directory, content, and casual games.',
        lead: 'Productivity tools, life content, casual games, and a curated geek directory — in one place.',
        documentTitle: 'Practical tools',
        documentDesc: 'Calculators, converters, documents, and life utilities — ready when you need them.',
        developerTitle: 'Developer utilities',
        developerDesc: 'JSON, PDF, translation portals and everyday helpers for builders.',
        navTitle: 'Geek directory',
        navDesc: 'Curated AI, developer, design, and productivity sites — China and overseas.',
        privacyTitle: 'Privacy-friendly',
        privacyDesc: 'Client-side tools run in your browser. Server tools discard files after processing.',
        builtTitle: 'Built for everyone',
        builtDesc: 'Clean UI in English and Chinese — no clutter, just tools that work.',
        authorTitle: 'About A Hui',
        authorLead: 'Independent developer sharing tech notes and practical tools.',
        authorNote: 'Content from Geek Frontier is gradually moving into this site.',
        contact: 'Contact',
        questions: 'Questions or feedback?',
        visitGuestbook: 'Visit the guestbook',
        friendLinks: 'Related sites',
        friendLinksLead: 'Related sites',
        friendGeek: 'Geek Frontier',
        friendGeekDesc: 'Original news & directory site (kept during migration)'
    },
    common: {
        serviceUnavailable: 'Service unavailable',
