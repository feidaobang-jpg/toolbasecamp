...
window.TB_LOCALES.en = {
    ...
    hub: {
        ...
        howtoBody: 'Option A: open Top up in the nav, pay via WeChat QR, then contact the admin to credit your balance. Option B: buy a redeem code from Xianyu seller feidaobang → redeem in Profile (top right). Then use Image-to-Image or Text-to-Image (charged only on success).',
        howtoRedeem: 'Redeem',
    ...
    about: {
        ...
        aiTitle: 'AI Images',
        aiDesc: 'Image-to-Image (instruct edit) and Text-to-Image. Paid from balance; charged only on success.',
        ...
        topUpHint: 'Need balance? Open Top up: pay via WeChat and message the admin, or redeem a Xianyu code.',
        goTopUp: 'Top up',
    ...
    topUp: {
        title: 'Top up',
        lead: 'Add balance for Image-to-Image and Text-to-Image. Charged only on success.',
