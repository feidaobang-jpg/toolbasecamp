...
window.TB_LOCALES.en = {
    ...
    privateHub: {
        ...
        ops: {
            ...
            stickersUploadDesc: 'PNG / JPG / GIF / WebP (multi-select). Every image is OCR’d: only images with detected text are saved; the display/download name is always the OCR text. No text → skipped. Single-frame GIFs go to Still; multi-frame to GIF. Duplicates use file content. Pick a category first, then upload.',
