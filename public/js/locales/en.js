...
window.TB_LOCALES.en = {
    ...
    tools: {
        ...
        imageCloud: {
            ...
            editTimeout: 'Image edit timed out. Multi-reference or 2K is slower — try 1K, fewer refs, or retry later. Charged only on success.',
        ...
        instructEdit: {
            ...
            outputSizeHint: 'Qwen Pro charges by output tier. Seedream minimum is 2K — choosing 1K still outputs and bills as 2K. Wan / Qwen 3.0 same price for both tiers. Default 2K.',
            modelWan27: 'Wan 2.7 · ≈¥0.4/image',
            modelWan27pro: 'Wan 2.7-Pro · ≈¥1.0/image',
            modelQwen30: 'Qwen Image 3.0 · ≈¥0.4/image',
            modelQwen30pro: 'Qwen Image 3.0 Pro · 1K ≈¥0.54 / 2K ≈¥1.0',
        ...
        aiMusic: {
            title: 'AI Music',
            desc: 'Generate songs or instrumentals with Alibaba Fun Music. Sign-in required; billed from balance by actual duration on success.',
            modeLabel: 'Mode',
            modePrompt: 'Prompt song',
            modeLyrics: 'Custom lyrics',
            modeInstrumental: 'Instrumental',
            prompt: 'Prompt',
            promptPh: 'e.g. Summer folk, acoustic guitar and harmonica, light mood for a travel vlog',
            lyrics: 'Lyrics',
            lyricsPh: '[Verse]\n...\n[Chorus]\n...',
            genderLabel: 'Voice',
            genderFemale: 'Female',
            ...
            costNote: 'About ¥{rate}/s (with markup). Estimate ≈ ¥{est} (based on {seconds}s). Charged by actual duration on success.',
            estimateLine: 'Estimate ≈ ¥{price} ({seconds}s)',
            tip: 'Tip:',
            tipBody: 'Generation often takes 1–3 minutes. Stay on this page. Charged only on success. Fun Music requires Model Studio invite access.',
            clear: 'Clear',
            download: 'Download',
            generating: 'Generating music…',
            needPrompt: 'Please enter a music prompt',
            needLyrics: 'Please enter lyrics',
            notConfigured: 'DashScope is not configured (DASHSCOPE_API_KEY).',
            failed: 'Generation failed. Try another prompt/lyrics, or confirm Fun Music invite access.',
            resultMeta: '{duration}s · charged ¥{price}'
        },
        idPhoto: {
            title: 'ID Photo',
