...
window.TB_LOCALES.en = {
    ...
    privateHub: {
        ...
        homePc: {
            ...
            gameSpriteHint: 'Brief → front/back/side stills (default 3, green→transparent) → pick SIDE hero for actions → Wan 5B → Godot ZIP.',
            ...
            gameSpriteStillsHint: 'Default 3-view: front, back, side hero (green keyed then transparent). Actions must use the side hero; front/back are design refs only. Zoom for large view.',
