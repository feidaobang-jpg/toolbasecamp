...
window.TB_LOCALES['zh-CN'] = {
    ...
    hub: {
        ...
        howtoTitle: '怎么充值',
        howtoBody: '方式一：微信扫码付款后联系管理员到账（收款码见「关于」页）。方式二：咸鱼搜索卖家 feidaobang 下单获兑换码 → 右上角「个人中心」兑换。然后用「图生图」或「文生图」（成功才扣余额）。',
        howtoRedeem: '去兑换',
        howtoAboutPay: '看收款码',
        howtoInstruct: '图生图',
    ...
    about: {
        ...
        aiTitle: 'AI 出图',
        aiDesc: '图生图（指令改图）、文生图；可用微信扫码或咸鱼兑换码充值，成功出图才扣余额。',
        lifeTitle: '内容与生活',
        ...
        topUpTitle: '充值说明',
        wechatPayTip: '微信扫下方收款码付款充值，付款后请联系管理员并告知你的登录账号，以便人工到账。也可咸鱼搜索卖家 feidaobang 购买兑换码，在「个人中心」自行兑换。',
        wechatPayAlt: '微信收款码',
        wechatPayCaption: '微信支付 · 扫码付款后联系管理员到账',
