...
window.TB_LOCALES['zh-CN'] = {
    ...
    tools: {
        ...
        imageCloud: {
            ...
            historyDownload: '下载',
            historyDelete: '删除',
            wechatBanner: '微信内下载常不可用：请点右上角 ··· → 在浏览器中打开；或长按图片保存到相册。',
            wechatSaveTip: '微信内无法使用下载按钮。请长按图片保存，或用系统浏览器打开本页后再下载。'
        },
        ocrText: {
            title: '识别文字',
        ...
        instructEdit: {
            ...
            tip: '提示：',
            tipBody: '新用户赠送 ¥3。成功出图按目录价×2 扣余额；失败不扣。结果会保存在本机历史，可稍后下载。默认推荐万相 2.6。',
            download: '下载',
            clear: '清除',
            needPrompt: '请填写修改说明',
        ...
        textToImage: {
            ...
            tip: '提示：',
            tipBody: '新用户赠送 ¥3。成功出图按目录价×2 扣余额；失败不扣。结果会保存在本机历史。默认可只用 Z-Image Turbo。',
            download: '下载',
            clear: '清除',
            needPrompt: '请填写提示词',
            needModel: '请至少选择一个模型',
