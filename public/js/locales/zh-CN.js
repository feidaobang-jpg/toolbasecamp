...
window.TB_LOCALES['zh-CN'] = {
    ...
    privateHub: {
        ...
        ops: {
            ...
            stickersUploadDesc: '支持 PNG / JPG / GIF / WebP（可多选）。单帧 GIF 会进「静图」，多帧进「动图」。文件名像 (47) 这类无意义名称时，会自动 OCR 图内文字作为展示名；查重按文件内容，不按序号文件名。请先点选分类再上传。',
            stickersPick: '选择图片',
            stickersCategory: '分类',
            ...
            stickersUploadDone: '上传完成：成功 {ok}，跳过重复 {dup}，失败 {fail}，共选 {total}',
            ...
            stickersCatSticker: '表情包',
            stickersCatWallpaper: '壁纸',
            stickersCatComic: '漫画',
            stickersCatScenery: '风景',
            stickersCatPeople: '人物',
            stickersCatPet: '萌宠',
            stickersCatOther: '其他',
    ...
    hub: {
        ...
        imagesPage: {
            ...
            stickersSub: '站长上传的图片（表情包、壁纸等），可按分类浏览，或长按转发给微信好友。',
            tip: 'GIF 进入可视区域会自动播放；列表缩略图可长按快速转发。点图打开原图后再长按可保存/转发高清。点「下载」会提示在浏览器中打开。',
            stickersTip: 'GIF 进入可视区域会自动播放。手机百度分享请先点开图片 →「打开原图」→ 等图显示完再长按（直接长按缩略图容易发黑）。',
            stickersLongPress: '请点下方「打开原图」，等白底图显示完后再长按分享。',
            stickersBaiduShareTip: '手机百度：请点下方「打开原图」，等白底图完全显示后再长按分享给微信。直接长按缩略图/预览图容易只有黑底。',
            stickersTapOpen: '长按缩略图可快速转发（清晰度较低）；点图打开后请再点「打开原图」长按，可避免发黑',
    ...
    tools: {
        ...
        refToVideo: {
            title: '参考生视频',
            desc: '上传 1～9 张人物/场景参考图，用提示词重拍梗片（如华强买瓜改版）。人物尽量保持一致。单次最长 15 秒，做不了原生 2 分钟。',
            modelLine: '模型：happyhorse-1.1-r2v · 最多 9 张参考图',
            dropTitle: '点击或拖入参考图',
            dropHint: '1～9 张 · JPG/PNG/WebP · 短边≥400px · 单张≤8MB。顺序对应 [Image 1]、[Image 2]…',
            promptLabel: '画面提示词',
            ...
            durationLabel: '时长',
            durationHint: '仅 3～15 秒（接口上限）。约 2 分钟需多段生成后自行拼接。',
            resolutionLabel: '分辨率',
            ratioLabel: '画面比例',
            res480: '480P · 更省（约 ¥0.9/秒）',
            res720: '720P · 推荐（约 ¥1.8/秒）',
            res1080: '1080P · 更清晰（约 ¥2.4/秒）',
            costNote: 'HappyHorse R2V：与文生视频同档（480P 约 ¥0.9/秒、720P 约 ¥1.8/秒、1080P 约 ¥2.4/秒）。单次最长 15 秒。仅成功才扣费。',
            estimateLine: '本次约 ¥{price}（{duration} 秒 · {resolution}）',
            tip: '提示：',
            tipBody: '华强改版：图1=买家定妆，图2=卖瓜人。点「华强买瓜」预设，再生成 10～15 秒。更长片请多跑几段后用剪辑软件拼接。',
            run: '生成',
            downloadMp4: '下载 MP4',
            clear: '清除',
            notConfigured: '服务端未配置 DashScope（DASHSCOPE_API_KEY）。',
        ...
        textToImage: {
            ...
            tip: '提示：',
            tipBody: '成功出图才扣余额，失败不扣。结果保存在本机历史。默认输出全彩（除非你要求黑白/线稿）。推荐 MiniMax Image-01。GPT Image 2 / Nano Banana Pro 经逍遥中转。多模型会逐个生成并展示。',
            publicLabel: '公开到顶部「图片」列表',
            publicHint: '默认不公开。勾选后所有人可在「图片」页浏览与下载。',
            download: '下载',
            clear: '清除',
        ...
        aiMusic: {
            title: 'AI 音乐',
            desc: '用风格与歌词生成歌曲/纯音乐（MiniMax Music）。需登录；Music-3.0-free 免费，Music-3.0 成功后扣 ¥2/首。',
            modelLabel: '模型',
            ...
            tip: '提示：',
            tipBody: '生成通常需 1–3 分钟（自动歌词会先写词再出歌），请停留在本页。成功出歌才扣费。免费模型 RPM 较低，繁忙时可换 Music-3.0。',
            clear: '清除',
            download: '下载',
            downloadLyrics: '下载歌词',
