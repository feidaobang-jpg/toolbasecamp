...
window.TB_LOCALES['zh-CN'] = {
    ...
    hub: {
        ...
        howtoTitle: '怎么充值',
        howtoBody: '方式一：顶部「充值」页微信扫码付款后联系管理员到账。方式二：咸鱼搜索卖家 feidaobang 下单获兑换码 → 右上角「个人中心」兑换。然后用「图生图」或「文生图」（成功才扣余额）。',
        howtoRedeem: '去兑换',
        howtoAboutPay: '去充值',
        howtoInstruct: '图生图',
    ...
    about: {
        ...
        aiTitle: 'AI 出图',
        aiDesc: '图生图（指令改图）、文生图；可用余额付费出图，成功才扣费。',
        lifeTitle: '内容与生活',
        ...
        topUpHint: '需要余额时请到「充值」页：微信扫码付款后联系管理员，或使用咸鱼兑换码。',
        goTopUp: '去充值',
