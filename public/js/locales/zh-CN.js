...
window.TB_LOCALES['zh-CN'] = {
    ...
    hub: {
        ...
        imagesPage: {
            ...
            stickersBaiduShareTip: '手机百度：请点「打开原图」→ 等白底图显示完再长按分享。百度分享常会变成静图（动图请用下载）。',
            stickersLongPress: '请点「打开原图」，等白底图显示完后再长按分享（动图请用下载）。',
            stickersTip: 'GIF 进入可视区域会自动播放。手机百度分享：点开图片 →「打开原图」→ 长按（多为静图白底；要动图请下载）。',
