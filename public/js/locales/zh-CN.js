...
window.TB_LOCALES['zh-CN'] = {
    ...
    tools: {
        ...
        instructEdit: {
            title: '指令改图',
            desc: '上传图片并用文字描述修改。使用阿里云 DashScope。需登录，计入每日限额。',
            dropTitle: '点击或拖入图片',
            dropHint: 'JPG / PNG / WebP，最大 8MB',
            prompt: '修改说明',
            promptPh: '例如：把天空改成蓝色，去掉左边的人…',
            tip: '提示：',
            tipBody: '描述尽量具体。每次消耗 1 次额度。请及时下载结果。',
            download: '下载',
            clear: '清除',
            needPrompt: '请填写修改说明',
            tooLarge: '图片不能超过 8MB',
    ...
    about: {
        title: '关于工具大本营',
        metaDescription: '关于工具大本营与站长阿辉 — 效率工具、导航、内容与小游戏。',
        lead: '效率工具、生活内容、小游戏与极客导航，一站搞定。',
        documentTitle: '实用工具',
        documentDesc: '计算、转换、文档与生活向小工具，随开随用。',
        developerTitle: '开发者能力',
        developerDesc: 'JSON、PDF、翻译等门户与日常开发辅助。',
        navTitle: '极客导航',
        navDesc: '精选 AI、开发、设计与效率网站，国内外分类收录。',
        privacyTitle: '注重隐私',
        privacyDesc: '客户端工具在浏览器中运行；服务端处理完即丢弃文件。',
        builtTitle: '为所有人打造',
        builtDesc: '中英文界面，简洁无干扰 — 专注好用的工具。',
        authorTitle: '关于阿辉',
        authorLead: '个人开发者，分享技术资讯与实用工具。',
        authorNote: '「极客前沿」的内容正逐步并入本站。',
        contact: '联系方式',
        questions: '有问题或建议？',
        ...
        friendGeek: '极客前沿',
        friendGeekDesc: '原资讯与导航站点（迁移过渡期保留）'
    },
    common: {
        serviceUnavailable: '服务不可用',
