...
window.TB_LOCALES['zh-CN'] = {
    ...
    tools: {
        ...
        instructEdit: {
            ...
            refModeMultiHint: '多图参考：第 1 张为主图，其余为参考；说明里可写「图1人物 + 图2服装」等。不支持批量，需至少 2 张。',
            dropTitle: '点击或拖入图片（可多选）',
            dropHint: 'JPG / PNG / WebP，单张最大 8MB，最多 4 张（批量）',
            dropHintMulti: 'JPG / PNG / WebP，单张最大 8MB，2～4 张一起参考合成',
            sourceMain: '主图',
            sourceRef: '参考{n}',
            ...
            modelSeedream50: '豆包 Seedream 5.0 · 约 ¥0.44/张',
