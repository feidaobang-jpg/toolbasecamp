...
window.TB_LOCALES['zh-CN'] = {
    ...
    tools: {
        ...
        instructEdit: {
            ...
            costHintEmpty: '请选择至少一个模型；费用 = 所选模型单价之和 × 图片张数。',
            costHint: '本次约 ¥{price}（{images} 张图 × {models} 个模型 = {runs} 次调用，扣 {runs} 次额度）',
            tip: '提示：',
            tipBody: '默认推荐万相 2.6。可多选模型对比；多图时排队生成，遇限流会自动重试。请及时下载。',
            download: '下载',
            clear: '清除',
            needPrompt: '请填写修改说明',
        ...
        textToImage: {
            ...
            sizeLandscape: '横版',
            modelLabel: '模型',
            modelZTurbo: 'Z-Image Turbo · 约 ¥0.04（推荐）',
            modelWan27: '万相 2.7 · 约 ¥0.3',
            modelWan27pro: '万相 2.7-Pro · 约 ¥0.6',
            model20: '千问 2.0 · 约 ¥0.2',
            selectAllModels: '全选',
            deselectAllModels: '取消全选',
            costHintEmpty: '请选择至少一个模型。',
            costHint: '本次约 ¥{price}（{models} 个模型 = {runs} 次调用，扣 {runs} 次额度）',
            tip: '提示：',
            tipBody: '写清主体、风格与光影。默认可只用 Z-Image Turbo；多选可对比。排队生成，遇限流/超时会重试。',
            download: '下载',
            clear: '清除',
            needPrompt: '请填写提示词',
            needModel: '请至少选择一个模型',
