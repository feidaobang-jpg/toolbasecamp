...
window.TB_LOCALES['zh-CN'] = {
    ...
    hub: {
        ...
        howtoTitle: '怎么充值',
        howtoBody: '新用户注册送 ¥5 余额。用完后：方式一 → 顶部「充值」页微信扫码付款后联系管理员到账；方式二 → 咸鱼搜索卖家 feidaobang 获兑换码，在「个人中心」兑换。然后用「图生图」或「文生图」（成功才扣余额）。邀请好友充值可得 10% 佣金（个人中心复制推广链接）。经销商批发兑码：单次满 ¥100 享 9 折、满 ¥300 享 8 折、满 ¥500 享 7 折；微信打款后联系管理员发码（微信/站内信）。',
        howtoRedeem: '去兑换',
        howtoAboutPay: '去充值',
        howtoInstruct: '图生图',
