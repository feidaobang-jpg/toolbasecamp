...
window.TB_LOCALES['zh-CN'] = {
    ...
    hub: {
        ...
        imagesPage: {
            ...
            stickersTip: 'GIF 进入可视区域会自动播放；缩略图可长按快速转发。点图打开原图后再长按可保存/转发高清。',
            stickersLongPress: '长按原图可保存或转发给朋友',
            stickersBaiduShareTip: '手机百度分享若发黑/不动：请先点「打开原图」，再长按分享（会走真实 GIF）。',
            stickersTapOpen: '长按缩略图可快速转发（清晰度较低）；点图打开原图后再长按，可保存/转发高清',
