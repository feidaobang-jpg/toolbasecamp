...
window.TB_LOCALES['zh-CN'] = {
    ...
    tools: {
        ...
        smartErase: {
            title: '智能擦除',
            desc: '框选擦除水印、马赛克与遮挡（服务器修复），或本地笔刷加马赛克。',
            dropTitle: '点击或拖入图片',
            dropHint: '支持 JPG、PNG、WebP',
            tip: '提示：',
            tipErase: '拖出选框覆盖水印/马赛克/小面积遮挡，点「擦除选区」。服务器 OpenCV 修复（会上传）。擦除后可继续编辑。',
            tipMosaic: '用笔刷涂抹即可加马赛克，全部在本地完成，不上传。',
            modeErase: '智能擦除',
            modeMosaic: '加马赛克',
            brushLabel: '笔刷大小',
            blockLabel: '马赛克块',
