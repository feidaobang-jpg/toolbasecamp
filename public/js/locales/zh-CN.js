...
window.TB_LOCALES['zh-CN'] = {
    ...
    tools: {
        ...
        refToVideo: {
            title: '参考生视频',
            desc: '上传参考图并用提示词重拍梗片（如华强买瓜）。可选 HappyHorse（更省）或 SD 2.5（逍遥，最长 30 秒）。',
            modelLabel: '模型',
            ...
            promptLabel: '画面提示词',
            promptPlaceholder: '用 [Image 1]、[Image 2] 指代上传的参考图。例如：[Image 1] 扮演华强，与 [Image 2] 卖瓜人争论…',
            presetHuaqiang: '华强买瓜',
            presetStreet: '街头砍价',
            presetDuo: '双人短剧',
            presetTexts: {
                huaqiang: '[Image 1] 扮演华强，[Image 2] 扮演卖瓜人。夏日路边瓜摊，华强拍瓜、尝瓜后说「这瓜保熟吗」，卖瓜人热情回应，随后因「沙瓤/生瓜」发生经典争执，表情夸张、对白清晰、镜头在两人与瓜摊之间切换，喜剧感强，画面流畅自然。',
            ...
            estimateLine: '本次约 ¥{price}（{duration} 秒 · {resolution}）',
            tip: '提示：',
            tipBody: '华强改版：图1=买家定妆，图2=卖瓜人。点「华强买瓜」预设再生成。SD 2.5 更贵但更长、画质更强。',
            run: '生成',
            downloadMp4: '下载 MP4',
            clear: '清除',
        ...
        videoEdit: {
            ...
            promptLabel: '编辑指令',
            promptPlaceholder: '例如：把视频里买瓜的人换成参考图中的人物，保留瓜摊和对白节奏',
            presetFace: '换脸',
            presetClothes: '换衣服',
            presetBg: '换背景',
            presetTexts: {
        ...
        aiMusic: {
            title: 'AI 音乐',
            desc: '用风格与歌词生成歌曲/纯音乐（MiniMax / Suno）。需登录；Music-3.0-free 免费，付费模型成功后扣费。',
            modelLabel: '模型',
            ...
            styleEdm: '电子',
            styleCinematic: '电影感',
            costNote: '当前模型 {model}：成功出歌扣 ¥{price}/首（免费模型为 ¥0）。',
            generateFree: '¥0 生成',
