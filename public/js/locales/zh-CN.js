...
window.TB_LOCALES['zh-CN'] = {
    ...
    auth: {
        ...
        redeemTitle: '兑换码充值',
        redeemHint: '输入管理员发放的兑换码，为 AI 出图余额充值。',
        redeemCode: '兑换码',
        redeemBtn: '兑换',
    ...
    tools: {
        ...
        imageCloud: {
            ...
            balanceLine: 'AI 余额 ¥{balance}（新用户赠送 ¥{gift}，成功出图按目录价×{markup} 扣费）',
            balanceUnlimited: '管理员账号：AI 余额不限（不扣费）',
            insufficientBalance: 'AI 余额不足，请充值或改选更便宜/更少的模型。',
