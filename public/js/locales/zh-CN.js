...
window.TB_LOCALES['zh-CN'] = {
    ...
    tools: {
        ...
        aiMusic: {
            title: 'AI 音乐',
            desc: '用提示词或歌词生成歌曲/纯音乐（阿里 Fun Music）。需登录，成功后按实际时长从余额扣费。',
            modeLabel: '模式',
            modePrompt: '提示词成歌',
            modeLyrics: '自定义歌词',
            modeInstrumental: '纯音乐',
            prompt: '音乐描述',
            promptPh: '例如：夏日清新民谣，木吉他与口琴，轻快节奏，适合旅行 Vlog',
            lyrics: '歌词',
            lyricsPh: '[Verse]\n……\n[Chorus]\n……',
            genderLabel: '人声',
            genderFemale: '女声',
            ...
            styleEdm: '电子',
            styleCinematic: '电影感',
            costNote: '约 ¥{rate}/秒（含加价），预估约 ¥{est}/首（按 {seconds} 秒估算）。成功后按实际时长扣费。',
            estimateLine: '预估约 ¥{price}（按 {seconds} 秒）',
            tip: '提示：',
            tipBody: '生成通常需 1–3 分钟，请停留在本页。成功出歌才扣费。Fun Music 需在百炼模型广场开通邀测。',
            clear: '清除',
            download: '下载',
            ...
            failed: '生成失败，请换描述/歌词再试，或确认已开通 Fun Music 邀测。',
            resultMeta: '时长 {duration} 秒 · 本次扣费 ¥{price}'
        },
        idPhoto: {
            title: '制作证件照',
