...
window.TB_LOCALES['zh-CN'] = {
    ...
    hub: {
        ...
        imagesPage: {
            ...
            tip: '列表为缩略图。点图查看原图后可长按保存或转发；点「下载」会提示在浏览器中打开。',
            stickersTip: '列表为缩略图。点图查看原图后，微信内可长按「保存到手机」或「转发给朋友」。',
            stickersLongPress: '长按图片可保存或转发给朋友',
            stickersTapOpen: '点图查看原图，再长按保存/转发',
