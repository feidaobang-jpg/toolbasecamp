...
window.TB_LOCALES['zh-CN'] = {
    ...
    tools: {
        ...
        speechTts: {
            title: '语音合成',
            desc: 'MiniMax speech-2.8 文本转语音，支持音色克隆。需登录，成功后按字符与克隆费从钱包扣费。',
            modelLabel: '模型',
            voiceLabel: '音色',
            voiceSelectedPrefix: '当前选用：',
            voiceFilterPh: '搜索音色…',
            voiceFilterEmpty: '没有匹配的音色',
            voiceHint: '单选：点选一个音色用于合成（不是多选，也不会插入提示词）。虚线边框为已克隆音色。',
            textLabel: '文本',
            textPh: '输入要朗读的文字…',
            speedLabel: '语速',
            tip: '提示：',
            tipBody: '成功合成后按字符×模型单价扣费。克隆音色首次正式合成时另扣克隆费（目录价 ¥9.9×加价）。列表中带 * 的克隆音色表示尚未扣克隆费。',
            run: '生成',
            download: '下载',
            clear: '清除',
            generating: '正在合成…',
            cloning: '正在克隆音色…',
            costNote: '当前 {model}：约 ¥{rate}/万字符；预估本次 ¥{estimate}（含待扣克隆费时另计，克隆费约 ¥{cloneFee}）。',
            needText: '请输入文本',
            needVoice: '请选择音色',
            tooLong: '文本过长（最多 {max} 字）',
            needCloneFile: '请上传用于克隆的音频（mp3 / m4a / wav，10 秒–5 分钟）',
            cloneTitle: '音色克隆',
            cloneHint: '上传 mp3 / m4a / wav，时长 10 秒–5 分钟，最大 15MB。试听只扣合成字符费；克隆费在该音色首次正式合成时收取。',
            cloneLabel: '名称',
            cloneLabelPh: '我的音色',
            cloneRun: '克隆并试听',
            cloneOk: '克隆试听完成 · 试听扣费 ¥{price} · 首次合成将另扣克隆费约 ¥{fee}',
