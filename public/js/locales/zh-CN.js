...
window.TB_LOCALES['zh-CN'] = {
    ...
    tools: {
        ...
        todoList: {
            ...
            stats: '{pending} 待办 · {doing} 进行中 · {done} 已完成',
            emptyText: '请输入任务内容',
            invalidStatus: '状态无效',
            statusPending: '待办',
            statusDoing: '进行中',
            statusDone: '已完成',
            cycleStatus: '点击切换状态：待办 → 进行中 → 已完成',
            editHint: '双击可编辑'
        },
        taskList: {
            title: '任务清单',
            desc: '按类型记录事项，仅未完成 / 已完成。需登录。',
            placeholder: '写一条事项…',
            add: '添加',
            type: '类型',
            filterAllCats: '全部类型',
            ...
            filterPending: '未完成',
            filterDone: '已完成',
            empty: '还没有事项，选好类型后添加一条吧。',
            clearDone: '清除已完成',
            clearDoneConfirm: '确定清除当前筛选下的已完成事项？',
            deleteConfirm: '删除「{text}」？',
            stats: '{pending} 未完成 · {done} 已完成',
            emptyText: '请输入事项内容',
            invalidCategory: '类型无效',
            statusPending: '未完成',
            statusDone: '已完成',
