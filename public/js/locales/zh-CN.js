...
window.TB_LOCALES['zh-CN'] = {
    ...
    privateHub: {
        ...
        ops: {
            ...
            stickersTitle: '传统图片管理',
            stickersDesc: '批量上传传统图片（表情包、精美图等），公开到图片模块「传统图片」Tab；微信内可长按保存或转发。',
            stickersLoading: '加载中…',
            stickersUploadTitle: '批量上传',
            stickersUploadDesc: '支持 PNG / JPG / GIF / WebP（可多选）。文件名「分类-名称.png」可自动解析分类；也可填写统一分类。',
            stickersPick: '选择图片',
            stickersCategory: '统一分类',
            stickersCategoryLabel: '分类',
            stickersRefresh: '刷新列表',
            stickersPublic: '查看公开图片页',
            stickersListTitle: '传统图片列表',
    ...
    hub: {
        ...
        imagesPage: {
            ...
            stickersSub: '站长上传的传统图片（表情包、精美图等），可下载或长按转发给微信好友。',
