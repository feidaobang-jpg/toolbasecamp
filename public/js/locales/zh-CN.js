...
window.TB_LOCALES['zh-CN'] = {
    ...
    hub: {
        ...
        imagesPage: {
            title: '图片',
            sub: '用户勾选公开后展示的 AI 生成图片（文生图 / 图生图）。默认不公开。',
    ...
    tools: {
        ...
        gifSticker: {
            title: 'GIF / 表情包加工',
            desc: '本地裁切方形、加字、压缩，适配微信聊天表情尺寸，不上传。',
            dropTitle: '点击或拖入图片 / GIF',
            dropHint: '支持 JPG、PNG、WebP、GIF',
            sizeLabel: '输出尺寸',
            size240: '240 × 240（微信表情常用）',
            size512: '512 × 512',
            focusX: '裁切焦点（左右）',
            focusY: '裁切焦点（上下）',
            captionLabel: '加字（可选）',
            captionPh: '梗图文字，如：震惊、无语',
            formatLabel: '导出格式',
            ...
            encoding: '编码中…',
            tip: '提示：',
            tipBody: '微信内可长按下方预览图保存/转发；或点下载后按提示操作。',
            wechatBanner: '微信内：长按结果图保存到手机或转发给朋友；GIF 文件请用浏览器打开后下载。',
            meta: '原图 {width} × {height} → 输出 {out} × {out}',
            invalidFile: '请选择图片或 GIF 文件',
            loadFailed: '文件加载失败',
            exportFailed: '导出失败',
            gifUnavailable: 'GIF 编码不可用，请换 PNG/JPEG'
        },
        imageResize: {
            title: '调整大小',
        ...
        aiMeme: {
            title: 'AI 梗图 / 表情',
            desc: '文字或照片生成 1:1 方形梗图/贴纸。需登录，成功出图扣余额。',
            modeLabel: '模式',
            modeText: '纯文字',
            modePhoto: '照片改梗图',
            modeTextHint: '描述想要的梗图/表情，输出 1:1 方形。',
            modePhotoHint: '上传照片并描述如何改成梗图/表情。',
            dropTitle: '点击或拖入照片',
            dropHint: 'JPG / PNG / WebP，纯文字模式可不传',
            removePhoto: '移除照片',
            prompt: '描述',
            promptPh: '例如：一只震惊的猫，大眼睛，搞笑 meme 风格…',
            styleLabel: '梗图预设',
            styleHint: '点预设会把风格提示追加到描述里（可再改）。',
            styleSticker: '贴纸',
            styleMeme: '梗图',
            styleQ版: 'Q 版',
            styleEmoji: '表情系列',
            styleReaction: '反应类',
            modelLabel: '模型',
            modelZTurbo: 'Z-Image Turbo · ¥0.08（推荐）',
            modelLive: 'MiniMax Image-01-Live（动漫插画）· ¥0.05',
            model01: 'MiniMax Image-01 · ¥0.05',
            modelWan27: '万相 2.7 · ¥0.4',
            costHintEmpty: '请选择至少一个模型。',
            costHint: '本次扣 ¥{price}（{models} 个模型 = {runs} 次，成功才扣费）',
            tip: '提示：',
            tipBody: '默认生成单张贴纸（一个主体、粗白边），不是拼图或九宫格。推荐 Z-Image Turbo。微信内请长按结果图保存或转发。',
            download: '下载',
            clear: '清除',
            needPrompt: '请填写描述',
            needPhoto: '请上传照片',
